...
const EmblaCarouselThumb = ({ slides, options }) => {
    ...
    return (
        <div className="emblathumb">
            <div className="emblathumb__viewport overflow-hidden rounded h-80 border  w-full md:w-[24rem] shadow-md shadow-black-800" ref={emblaMainRef}>
            ...
            <div className="emblathumb-thumbs border-y border-gray-300 p-2 w-full md:w-96 m-auto">
